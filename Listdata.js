...
import { faGraduationCap, faChevronRight, faUtensils } from '@fortawesome/free-solid-svg-icons';

const Listdata = () => {

  const jsonUrl = 'http://192.168.235.236:3000/mahasiswa';
  const [isLoading, setLoading] = useState(true);
  const [dataUser, setDataUser] = useState([]); // Set to empty array
                ...
                <TouchableOpacity>
                  <View style={styles.card}>
                    <View style={styles.avatar}>
                      <FontAwesomeIcon icon={faUtensils} size={50} color={item.color} />
                    </View>
                    <View>
